...
<body>
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        x="0px" y="0px" viewBox="0 0 1400 300" style="enable-background:new 0 0 1400 300;" xml:space="preserve"
        class="svg-nav">
        <g>
    ...
    <nav class="nav nav-login">
        <div class="nav-container">
            ...
            <div class="button-container">
                <a href="/home_tutor.html">Home</a>
                <a href="/messages.html">Messages</a>
                <form class="search-box" action="/search-for-tutor.html">
                    <svg>
            ...
            <div class="user-photo-container">
                <img src="assets/sophia.png" alt="user photo" id="tutor-profile-photo">    
            </div>
    ...
    <!-- defined javascript -->
    <script src="js/profile_tutor.js"></script>

...
Route::group([
    ...
    // ================ reset password ============
    Route::get('/reset-password/student', 'Auth\LoginController@indexResetPasswordStudent')->name('reset-password.index.student');
    Route::post('/reset-password/student', 'Auth\LoginController@resetPasswordStudent')->name('reset-password.store.student');
    Route::get('/reset-password/tutor', 'Auth\LoginController@indexResetPasswordTutor')->name('reset-password.index.tutor');
    Route::post('/reset-password/tutor', 'Auth\LoginController@resetPasswordTutor')->name('reset-password.store.tutor');
});

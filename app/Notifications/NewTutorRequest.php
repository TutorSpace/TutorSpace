...
class NewTutorRequest extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ...
                ->line('You just received a New Tutor Request from ' . $this->tutorRequest->student->first_name . '! The session is from ' . $this->tutorRequest->session_time_start . ' to ' . $this->tutorRequest->session_time_end)

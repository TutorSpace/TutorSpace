...
<body class="animsition @yield('body-class')" onload="">
    <div id="background-cover" class="background-cover">
        @yield('add-post-container')
        @yield('write-review-container')
    </div>
    <div id="background-cover-2" class="background-cover">
        @yield('signup-wizard-container')
    </div>
    <div id="background-cover-3" class="background-cover">
        @yield('confirm-time-container')
    </div>
        ...
        <div class="nav-container">
            ...
            <div class="button-container">
                ...
                <form class="search-box" action="/search" method="GET">
                    ...
                    <input type="text" name="navInput" placeholder="Search name, course, or subject" type="submit">
                </form>
            </div>
            <div class="user-photo-container">
                <div class="p-relative">
                    <img src="{{asset("user_photos/{$user->profile_pic_url}"),}}" alt="user photo"
                        id="current-user-profile-photo" data-user-id="{{$user->id}}">

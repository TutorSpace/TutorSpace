                ...
                <div
                    ...
                    <div class="profile__form-row flex-wrap">
                        <div class="autocomplete mb-3">
                            <label for="course" class="profile__label p-relative" id="help-user-info">
                                @if (Auth::user()->is_tutor)
                                Courses you would like to tutor
                                @else
                                Courses you are taking this semester
                                @endif
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle svg-help" viewBox="0 0 16 16" id="svg-help-user-info">

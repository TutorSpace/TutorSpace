<div class="container modal-session-cancel">
    <h6 class="w-100 text-center my-5">Are you sure you want to cancel the session?</h6>
    <p class="w-100 text-center my-5 fc-black-2">You will be charged <span class="text-danger font-weight-bold">$5</span> for cancellation penalty</p>

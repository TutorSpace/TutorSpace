    ...
    <div class="notification__content__info__wrapper">
        ...
        <div class="container content">
            ...
            <div class="quote">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda cupiditate reiciendis eius architecto amet. Ullam itaque consequatur labore eligendi cupiditate ad quis minima illo, ratione quidem tempore, facere inventore dolor!
                </p>
                <svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.112 0.0159998H7.76L4.544 11.536H0.176L4.112 0.0159998ZM13.088 0.0159998H16.736L13.52 11.536H9.152L13.088 0.0159998Z" fill="black"/>
                </svg>

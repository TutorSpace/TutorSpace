...
<div class="container search-container">
    <h2 style="search__header">Search Results</h2>
    <div class="search__box">
        <svg>
            <use xlink:href="assets/sprite.svg#icon-magnifying-glass"></use>
        </svg>
        <input type="text" placeholder="Add Subjects" class="">
    </div>
    ...
    <div class="filter-container">
        ...
        <div class="filter-box">
            ...
            <div class="filter">
                <label for="price-range-low">Low: <span id="price-range-low-value">20</span></label>
                <input type="range" class="custom-range price-range" min="10" max="30" id="price-range-low">

                <label for="price-range-high">High: <span id="price-range-high-value">45</span></label>
                <input type="range" class="custom-range price-range" min="30" max="60" id="price-range-high">
                <div class="button-container">

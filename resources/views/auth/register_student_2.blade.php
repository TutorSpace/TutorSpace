...
<div class="container signup">
    ...
    <div class="signup--right signup--right-student p-relative">
        <svg class="btn-close fill-color-blue-primary" width="1em" height="1em" viewBox="0 0 16 16"  xmlns="http://www.w3.org/2000/svg" data-back-href="{{ route('index') }}">
            {{-- for empty --}}
        ...
        <form action="{{ route('register.store.student.2') }}" method="POST">
            ...
            <div class="form-group-4">
                <input type="text" class="form-control signup-form-input signup-form-input-email square @if ($errors->any()) invalid @endif" name="code-1" value="{{ old('code-1') }}" maxlength="1" required>
                <input type="text" class="form-control signup-form-input signup-form-input-email square @if ($errors->any()) invalid @endif" name="code-2" value="{{ old('code-2') }}" maxlength="1" required>
                <input type="text" class="form-control signup-form-input signup-form-input-email square @if ($errors->any()) invalid @endif" name="code-3" value="{{ old('code-3') }}" maxlength="1" required>
                <input type="text" class="form-control signup-form-input signup-form-input-email square @if ($errors->any()) invalid @endif" name="code-4" value="{{ old('code-4') }}" maxlength="1" required>
            </div>
            @if ($errors->any())
            ...
            <div class="signup-container-bottom mt-5 p-relative">
                <span class="fs-2 fc-grey p-relative left-n-2 inline-grid">
                    ...
                    <a href="mailto:tutorspacehelp@gmail.com" class="btn-link-student">tutorspacehelp@gmail.com</a>
                </span>
                {{-- btn-next --}}

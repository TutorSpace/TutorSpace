...
$.ajax({
  ...
  success: function success(data) {
    ...
    autocomplete(document.getElementById("tag"), tags, profile_add_tag); // if(hourlyRateInp = document.getElementById("hourly-rate")) autocomplete(hourlyRateInp, hourlyRate, updateHourlyRate);
  }
});

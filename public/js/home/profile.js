...
$('.boxes__course .box .remove').on('click', function () {
  $(this).closest('.box').remove(); // TODO - YASHVI: get the tag id of the element clicked

  var new_tag_id = 1;
  ajaxAddRemoveTag(new_tag_id);
});
$('.boxes__forum .box .remove').on('click', function () {
  $(this).closest('.box').remove(); // TODO - YASHVI: get the tag id of the element clicked
...
function profile_add_course() {
  ...
  if ($('.boxes__course .box .label').text().includes(new_course)) {
    toastr.error("The course is already selected ");
      ...
      appendNewBox(new_course, '.boxes__course'); // TODO - YASHVI: get the course id of the element clicked
...
function profile_add_tag() {
  ...
  if ($('.boxes__forum .box .label').text().includes(new_tag)) {
    ...
    toastr.error("The tag is already selected ");
      ...
      appendNewBox(new_tag, '.boxes__forum'); // TODO - YASHVI: get the course id of the element clicked
